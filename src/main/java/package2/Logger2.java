...
public final class Logger2 /*implements org.slf4j.Logger, LocationAwareLogger, AppenderAttachable<ILoggingEvent>, Serializable*/ {
//
...
//
//    Logger2(String name, Logger parent, LoggerContext loggerContext) {
//        this.name = name;
//        this.parent = parent;
